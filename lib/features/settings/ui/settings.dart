...
class Settings extends StatefulWidget {
  ...
  const Settings({Key key, this.avatarUrl}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return CustomScaffold(
      ...
      body: ListView(
        children: <Widget>[
          SettingsListTile(
            leading: CircularNetworkImage(imageUrl: widget.avatarUrl),
...
class SettingsListTile extends StatelessWidget {
  ...
  const SettingsListTile({Key key, this.leading, this.text, this.onTap, this.hideTrailing = false}) : super(key: key);
